...
while ($checkTelephoneNumber){
	$telephone = Read-Host "Enter the User's DID phone number. `"+1`" followed by 10 digit number (+12224448888)."
...
Write-Output "`n`nEmail = $email`nTelephone = $telephone`nExtension = $extension"
